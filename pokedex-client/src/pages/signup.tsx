    ...
    return (
        <>
            ...
            <div className='relative login-page-container h-screen w-full flex justify-center items-center'>
                <div className="fixed z-0 -top-[600px] bottom-0 left-0 right-0 skew-y-[12deg] w-full h-full bg-slate-50 origin-[0]">
                    <div className="z-10 absolute stripe h-10 bg-green-600 opacity-70 bottom-0 left-[0] right-[calc(50%+460px)]" />
                    <div className="z-10 absolute stripe h-10 bg-green-900 opacity-70 bottom-8 left-[calc(50%-650px)] right-[calc(50%+540px)]" />
                    <div className="z-10 absolute stripe h-10 bg-green-900 opacity-70 -bottom-8 left-[calc(50%+360px)] right-0" />
